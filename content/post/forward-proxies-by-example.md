...
[CONNECT](https://tools.ietf.org/html/rfc7231#section-4.3.6) is used to establish a [tunnel](https://en.wikipedia.org/wiki/HTTP_tunnel) to the destination server. The follow is a simple `curl` command with the output and corresponding "one-shot" proxy code:
